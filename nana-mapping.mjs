...
const DEFAULT_ROWS = [
  ...
  [25, "Colton Herta", "HER", 368439, "Cadillac", 390378],
  ...
  [34, "Jak Crawford", "CRA", 347908, "Aston Martin", 385362],
  [38, "Dino Beganovic", "BEG", 347535, "Ferrari", 385364],
  ...
  [46, "Luke Browning", "BRO", 347536, "Williams", 385365],
  [50, "Ryo Hirakawa", "HIR", 347541, "Haas F1 Team", 385361],
  [55, "Carlos Sainz", "SAI", 347548, "Williams", 385365],
  [61, "Paul Aron", "ARO", 347543, "Alpine", 385366],
  [63, "George Russell", "RUS", 347501, "Mercedes", 385358],
  [67, "Leonardo Fornaroli", "FOR", 368438, "McLaren", 385367],
  [72, "Frederik Vesti", "VES", 347526, "Mercedes", 385358],
  ...
  [90, "Ayumu Iwasa", "IWA", 347538, "Red Bull Racing", 385355],
];
